inherited fmCustomerSpecialPricecopy: TfmCustomerSpecialPricecopy
  HelpContext = 1285002
  Caption = 'Options'
  ClientHeight = 238
  ClientWidth = 415
  ...
  object DNMPanel2: TDNMPanel [4]
    ...
    object chkPD: TCheckBox
      ...
      Margins.Bottom = 8
      Align = alTop
      Caption = 'Permanent Dicount(%)'
      TabOrder = 2
    end
    object chkSPD: TCheckBox
      AlignWithMargins = True
      Left = 4
      Top = 75
      Width = 407
