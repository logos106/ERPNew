...
// WSDL     : C:\Dev\ERP\Dev\Aus_Gov\SBR\DotNet\C_Sharp\SBR_CoreServicesRequester_C#_1.2.0_2015-06-09\SBR_CoreServicesRequester\WSDL\Core\list.02.01.service.wsdl
//  >Import : C:\Dev\ERP\Dev\Aus_Gov\SBR\DotNet\C_Sharp\SBR_CoreServicesRequester_C#_1.2.0_2015-06-09\SBR_CoreServicesRequester\WSDL\Core\list.02.01.service.wsdl>0
...
// Encoding : UTF-8
// Version  : 1.0
// (19/06/2018 9:27:37 AM - - $Rev: 34800 $)
// ************************************************************************ //
...
type
  ...
  ResponseList         = class;                 { "http://sbr.gov.au/comn/list.02.service"[Lit][GblElm] }
  RequestList          = class;                 { "http://sbr.gov.au/comn/list.02.service"[Lit][GblElm] }
  ...
  // ************************************************************************ //
  // XML       : ResponseList, global, <element>
  // Namespace : http://sbr.gov.au/comn/list.02.service
  // Serializtn: [xoLiteralParam]
  // Info      : Wrapper
  // ************************************************************************ //
  ResponseList = class(TRemotable)
  private
  ...
  // ************************************************************************ //
  // XML       : RequestList, global, <element>
  // Namespace : http://sbr.gov.au/comn/list.02.service
  // Serializtn: [xoLiteralParam]
  // Info      : Wrapper
  // ************************************************************************ //
  RequestList = class(TRemotable)
  private
    FStandardBusinessDocumentMessage: StandardBusinessDocumentMessage;
  public
    constructor Create; override;
  ...
  // ************************************************************************ //
  // Namespace : http://sbr.gov.au/comn/list.02.service
  // soapAction: http://sbr.gov.au/services/list.02.service/List
  // transport : http://schemas.xmlsoap.org/soap/http
  // style     : document
  // use       : literal
  // binding   : List.02.SoapBinding
  // service   : List.02.Service
  // port      : List.02.Port
  // URL       : https://sbr.gov.au/services/list.02.service
  // ************************************************************************ //
  IList02 = interface(IInvokable)
  ['{82CCF2A8-77B2-95DB-2F39-BE7BFFA4934D}']

    // Cannot unwrap: 
    //     - Input element wrapper name does not match operation's name
    function  List(const parameters: RequestList): ResponseList; stdcall;
  end;

function GetIList02(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): IList02;


implementation
  uses SysUtils;

function GetIList02(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): IList02;
const
  defWSDL = 'C:\Dev\ERP\Dev\Aus_Gov\SBR\DotNet\C_Sharp\SBR_CoreServicesRequester_C#_1.2.0_2015-06-09\SBR_CoreServicesRequester\WSDL\Core\list.02.01.service.wsdl';
  defURL  = 'https://sbr.gov.au/services/list.02.service';
  defSvc  = 'List.02.Service';
  defPrt  = 'List.02.Port';
var
  RIO: THTTPRIO;
begin
...
constructor ResponseList.Create;
begin
  inherited Create;
  FSerializationOptions := [xoLiteralParam];
end;

destructor ResponseList.Destroy;
begin
  SysUtils.FreeAndNil(FStandardBusinessDocumentMessage);
  inherited Destroy;
end;

constructor RequestList.Create;
begin
  inherited Create;
  FSerializationOptions := [xoLiteralParam];
end;

destructor RequestList.Destroy;
begin
  SysUtils.FreeAndNil(FStandardBusinessDocumentMessage);
  inherited Destroy;
end;
...
initialization
  { IList02 }
  InvRegistry.RegisterInterface(TypeInfo(IList02), 'http://sbr.gov.au/comn/list.02.service', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(IList02), 'http://sbr.gov.au/services/list.02.service/List');
  InvRegistry.RegisterInvokeOptions(TypeInfo(IList02), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(IList02), ioLiteral);
  InvRegistry.RegisterInvokeOptions(TypeInfo(IList02), ioSOAP12);
  ...
  RemClassRegistry.RegisterXSClass(ResponseList, 'http://sbr.gov.au/comn/list.02.service', 'ResponseList');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(ResponseList), 'StandardBusinessDocumentMessage', '[Namespace="http://sbr.gov.au/comn/sbdm.02.data"]');
  RemClassRegistry.RegisterSerializeOptions(ResponseList, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(RequestList, 'http://sbr.gov.au/comn/list.02.service', 'RequestList');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(RequestList), 'StandardBusinessDocumentMessage', '[Namespace="http://sbr.gov.au/comn/sbdm.02.data"]');
  RemClassRegistry.RegisterSerializeOptions(RequestList, [xoLiteralParam]);
