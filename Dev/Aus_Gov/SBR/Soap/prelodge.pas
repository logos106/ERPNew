...
// WSDL     : C:\Dev\ERP\Dev\Aus_Gov\SBR\DotNet\C_Sharp\SBR_CoreServicesRequester_C#_1.2.0_2015-06-09\SBR_CoreServicesRequester\WSDL\Core\prelodge.02.01.service.wsdl
//  >Import : C:\Dev\ERP\Dev\Aus_Gov\SBR\DotNet\C_Sharp\SBR_CoreServicesRequester_C#_1.2.0_2015-06-09\SBR_CoreServicesRequester\WSDL\Core\prelodge.02.01.service.wsdl>0
...
// Encoding : UTF-8
// Version  : 1.0
// (19/06/2018 9:30:25 AM - - $Rev: 34800 $)
// ************************************************************************ //
...
type
  ...
  ResponsePreLodgeReport = class;               { "http://sbr.gov.au/comn/prelodge.02.service"[Lit][GblElm] }
  RequestPreLodgeReport = class;                { "http://sbr.gov.au/comn/prelodge.02.service"[Lit][GblElm] }
  ...
  // ************************************************************************ //
  // XML       : ResponsePreLodgeReport, global, <element>
  // Namespace : http://sbr.gov.au/comn/prelodge.02.service
  // Serializtn: [xoLiteralParam]
  // Info      : Wrapper
  // ************************************************************************ //
  ResponsePreLodgeReport = class(TRemotable)
  private
  ...
  // ************************************************************************ //
  // XML       : RequestPreLodgeReport, global, <element>
  // Namespace : http://sbr.gov.au/comn/prelodge.02.service
  // Serializtn: [xoLiteralParam]
  // Info      : Wrapper
  // ************************************************************************ //
  RequestPreLodgeReport = class(TRemotable)
  private
    FStandardBusinessDocumentMessage: StandardBusinessDocumentMessage;
  public
    constructor Create; override;
  ...
  // ************************************************************************ //
  // Namespace : http://sbr.gov.au/comn/prelodge.02.service
  // soapAction: http://sbr.gov.au/services/prelodge.02.service/PreLodgeReport
  // transport : http://schemas.xmlsoap.org/soap/http
  // style     : document
  // use       : literal
  // binding   : PreLodge.02.SoapBinding
  // service   : PreLodge.02.Service
  // port      : PreLodge.02.Port
  // URL       : https://sbr.gov.au/services/prelodge.02.service
  // ************************************************************************ //
  IPreLodge02 = interface(IInvokable)
  ['{161A6A6E-EEB3-2CD5-ABD6-515BA661B6DC}']

    // Cannot unwrap: 
    //     - Input element wrapper name does not match operation's name
    function  PreLodgeReport(const parameters: RequestPreLodgeReport): ResponsePreLodgeReport; stdcall;
  end;

function GetIPreLodge02(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): IPreLodge02;


implementation
  uses SysUtils;

function GetIPreLodge02(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): IPreLodge02;
const
  defWSDL = 'C:\Dev\ERP\Dev\Aus_Gov\SBR\DotNet\C_Sharp\SBR_CoreServicesRequester_C#_1.2.0_2015-06-09\SBR_CoreServicesRequester\WSDL\Core\prelodge.02.01.service.wsdl';
  defURL  = 'https://sbr.gov.au/services/prelodge.02.service';
  defSvc  = 'PreLodge.02.Service';
  defPrt  = 'PreLodge.02.Port';
var
  RIO: THTTPRIO;
begin
  Result := nil;
...
constructor ResponsePreLodgeReport.Create;
begin
  inherited Create;
  FSerializationOptions := [xoLiteralParam];
end;

destructor ResponsePreLodgeReport.Destroy;
begin
  SysUtils.FreeAndNil(FStandardBusinessDocumentMessage);
  inherited Destroy;
end;

constructor RequestPreLodgeReport.Create;
begin
  inherited Create;
  FSerializationOptions := [xoLiteralParam];
end;

destructor RequestPreLodgeReport.Destroy;
begin
  SysUtils.FreeAndNil(FStandardBusinessDocumentMessage);
  inherited Destroy;
end;
...
initialization
  { IPreLodge02 }
  InvRegistry.RegisterInterface(TypeInfo(IPreLodge02), 'http://sbr.gov.au/comn/prelodge.02.service', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(IPreLodge02), 'http://sbr.gov.au/services/prelodge.02.service/PreLodgeReport');
  InvRegistry.RegisterInvokeOptions(TypeInfo(IPreLodge02), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(IPreLodge02), ioLiteral);
  InvRegistry.RegisterInvokeOptions(TypeInfo(IPreLodge02), ioSOAP12);
  ...
  RemClassRegistry.RegisterXSClass(ResponsePreLodgeReport, 'http://sbr.gov.au/comn/prelodge.02.service', 'ResponsePreLodgeReport');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(ResponsePreLodgeReport), 'StandardBusinessDocumentMessage', '[Namespace="http://sbr.gov.au/comn/sbdm.02.data"]');
  RemClassRegistry.RegisterSerializeOptions(ResponsePreLodgeReport, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(RequestPreLodgeReport, 'http://sbr.gov.au/comn/prelodge.02.service', 'RequestPreLodgeReport');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(RequestPreLodgeReport), 'StandardBusinessDocumentMessage', '[Namespace="http://sbr.gov.au/comn/sbdm.02.data"]');
  RemClassRegistry.RegisterSerializeOptions(RequestPreLodgeReport, [xoLiteralParam]);
