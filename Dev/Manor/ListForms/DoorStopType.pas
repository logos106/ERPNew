...
type
  TDoorStopTypeGUI = class(TBaseListingDoorLookupGUI)
    qryMainGlobalRef: TStringField;
    qryMainStopType: TStringField;
...
procedure TDoorStopTypeGUI.cmdNewClick(Sender: TObject);
var
    Form : TComponent;
begin
  inherited;
...
procedure TDoorStopTypeGUI.cmdPrintClick(Sender: TObject);
begin
  DisableForm;
  try
    inherited;
...
initialization
  RegisterClassOnce(TDoorStopTypeGUI);

finalization
  UnRegisterClass(TDoorStopTypeGUI);
