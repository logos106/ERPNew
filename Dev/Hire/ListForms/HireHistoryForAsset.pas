...
type
  THireHistoryForAssetGUI = class(TBaseListingGUI)
    lblSubtitle: TLabel;
...
{$R *.dfm}
procedure THireHistoryForAssetGUI.FormCreate(Sender: TObject);
begin
  inherited;
  AssetId := 0;
  StatusDateAsOn := 0;
...
procedure THireHistoryForAssetGUI.grdMainCalcCellColors(Sender: TObject;
...
procedure THireHistoryForAssetGUI.IterateselectedRecordsCallback(
...
procedure THireHistoryForAssetGUI.qryMainAfterOpen(DataSet: TDataSet);
begin
  inherited;
  fiStatusDateId:= 0;
...
procedure THireHistoryForAssetGUI.qryMainCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure THireHistoryForAssetGUI.RefreshQuery;
var
  s:String;
begin
...
procedure THireHistoryForAssetGUI.SetGridColumns;
begin
  inherited;
...
initialization
  RegisterClassOnce(THireHistoryForAssetGUI);
