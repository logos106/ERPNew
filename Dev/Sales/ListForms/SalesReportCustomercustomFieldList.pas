unit SalesReportCustomercustomFieldList;
...
type
  TSalesReportCustomercustomFieldListGUI = class(TSalesReportGUI)
  ...
  Protected
    ...
    Function CustomercustomFields(Const Tablealias:String) :String;Override;
...
{ TSalesReportCustomercustomFieldListGUI }

function TSalesReportCustomercustomFieldListGUI.CustomercustomFields(Const Tablealias:String): String;
...
function TSalesReportCustomercustomFieldListGUI.Customfields: String;
begin
...
function TSalesReportCustomercustomFieldListGUI.Extrafields: String;
var
  st:TStringlist;
begin
...
procedure TSalesReportCustomercustomFieldListGUI.FormCreate(Sender: TObject);
begin
  //NonSearchMode := True;
  inherited;
end;

procedure TSalesReportCustomercustomFieldListGUI.FormShow(Sender: TObject);
begin
  inherited;
  TitleLabel.caption := 'Customer Custom Fields';
end;

procedure TSalesReportCustomercustomFieldListGUI.SetGridColumns;
begin
  inherited;
  SetUpcustomFields('Cust');
end;

function TSalesReportCustomercustomFieldListGUI.TablenameSufix: String;
begin
  REsult := 'cust';
end;

initialization
  RegisterClassOnce(TSalesReportCustomercustomFieldListGUI);
