unit FuncResourceAllocationList;
...
type
  TFuncResourceAllocationListGUI = class(TBaseListingGUI)
  private
...
procedure TFuncResourceAllocationListGUI.RefreshQuery;
begin
...
initialization
  RegisterClassOnce(TFuncResourceAllocationListGUI);
end.
