inherited RollaBlindCutoutSheetGUI: TRollaBlindCutoutSheetGUI
  Left = 240
  Top = 193
  Caption = 'Cut-out Sheet'
  ClientHeight = 574
  ClientWidth = 841
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  object qryHeading: TMyQuery
    SQL.Strings = (
      'SELECT ras.ProfileType, c.ClientID AS LeadNumber, '
      'CONCAT_WS(" ", c.Title, c.FirstName, c.LastName) AS Name,'
      'ras.OpeningHeight, ras.OpeningWidth, ras.Mod1Height,'
      'ras.Mod1Width, ras.InstallType, ras.SubInstallType'
      'FROM tblclients c'
      'INNER JOIN tblrollaaddsheet1 ras ON c.ClientID=ras.LeadNumber'
      'WHERE c.ClientID=:ClientID AND ras.SheetID=:SheetID;')
    Left = 168
    Top = 8
    ParamData = <
      item
  ...
  object qryCutting: TMyQuery
    ...
    object qryCuttingLength: TStringField
      DisplayWidth = 7
      FieldName = 'Length'
      Origin = 'tblrollaaddsheet2.Length'
      Size = 50
    end
