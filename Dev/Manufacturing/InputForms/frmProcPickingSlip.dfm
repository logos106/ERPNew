inherited fmProcPickingSlip: TfmProcPickingSlip
  Left = 33
  Top = 240
  HelpContext = 186000
  Caption = 'Production Picking Slip'
  ClientHeight = 493
  ClientWidth = 998
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  object Grid: TwwDBGrid [3]
    ...
    Selected.Strings = (
      ...
      'ItemTotalQtyOriginal'#9'10'#9'Qty Required'#9#9
      'ItemTotalQtyUsed'#9'10'#9'Qty Issued'#9#9
      ...
      'SaleLineShipDate'#9'10'#9'Line Ship Date'#9'F'
