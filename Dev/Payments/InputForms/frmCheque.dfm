inherited fmCheque: TfmCheque
  ...
  inherited pnlFooter: TDNMPanel
    ...
    inherited txtSalesComments: TDBMemo [16]
      Left = 72
      Top = 74
      Width = 246
      Height = 41
    ...
    inherited btnAttachments: TDNMSpeedButton [17]
      Left = 4
      Top = 24
      HelpContext = 244022
      TabOrder = 0
    ...
    object btnAddfollowupnotedate: TDNMSpeedButton [19]
      Left = 13
      Top = 48
      Width = 56
      Height = 13
    ...
    object btnAdddate: TDNMSpeedButton [20]
      Left = 14
      Top = 102
      Width = 56
      Height = 13
    ...
    object btnSignature: TDNMSpeedButton [21]
      Left = 488
      Top = 6
      Width = 65
      Height = 22
    ...
    inherited pnlProcessMessage: TDNMPanel [22]
      Width = 911
      HelpContext = 244086
      ExplicitWidth = 911
    ...
    object wwCreateRule: TwwCheckBox
      Left = 488
      Top = 59
      Width = 88
      Height = 17
  ...
  inherited imgPopup: TImageList
    ...
    Top = 325
    Bitmap = {
      494C01010200A800580110001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgsort: TImageList
    ...
    Top = 325
    Bitmap = {
      
