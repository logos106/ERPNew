inherited ImportPcodeToRatingAreaZoneGUI: TImportPcodeToRatingAreaZoneGUI
  Left = 392
  Top = 211
  HelpContext = 367000
  ...
  BorderIcons = []
  Caption = 'Import Postcode to Rating Area & Zone'
  ClientHeight = 215
  ClientWidth = 390
  ...
  object pnlTitle: TDNMPanel [8]
    ...
    object TitleShader: TShader
      ...
      object TitleLabel: TLabel
        ...
        Alignment = taCenter
        AutoSize = False
        Caption = 'Import Postcode to Rating Area'
        Font.Charset = ANSI_CHARSET
        Font.Color = clMaroon
        Font.Height = -23
        Font.Name = 'Arial'
  ...
  object OpenDialog1: TOpenDialog
    Filter = 'TNT Import Data (*.txt)|*.txt|All Files (*.*)|*.*'
    Left = 351
    Top = 116
  end
end
