...
function StringReplace_JOH_PAS_12(const S, OldPattern, NewPattern: AnsiString;  Flags: TReplaceFlags): AnsiString;
...
function AnsiPosExIC(const SubStr, S: Ansistring; Offset: Cardinal = 1): Integer;
var
...
type
  TPosEx = function(const SubStr, S: string; Offset: Cardinal): Integer;
const
  StaticBufferSize = 16;
var
