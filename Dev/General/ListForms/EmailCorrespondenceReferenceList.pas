unit EmailCorrespondenceReferenceList;
...
type
  TEmailCorrespondenceReferenceListGUI = class(TCorrespondenceReferenceListGUI)
  private
...
initialization
  RegisterClass(TEmailCorrespondenceReferenceListGUI);
