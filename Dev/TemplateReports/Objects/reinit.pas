...
begin
  ...
  P := PChar(@FileName) + FastFuncs.StrLen(FileName);
...
function ReloadInheritedComponent(Instance: TComponent; RootAncestor: TClass): boolean;
  ...
  begin
    ...
    Result := InternalReloadComponentRes(ClassType.ClassName, FindResourceHInstance(FindClassHInstance(ClassType)), Instance) or Result;
  end;
begin
