inherited fmProdSalesDescAttribMatrixListSelect: TfmProdSalesDescAttribMatrixListSelect
  Left = 460
  Top = 310
  ...
  object Label4: TLabel
    ...
    Height = 41
    AutoSize = False
    Caption = 'Drag and drop items between lists as required'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object edtAxis: TEdit
    ...
    ReadOnly = True
    TabOrder = 4
    OnDragDrop = edtAxisDragDrop
    OnDragOver = edtAxisDragOver
  end
end
