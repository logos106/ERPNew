unit BackorderPurchaseOrderApprovalExpress;
...
type
  TBackorderPurchaseOrderApprovalExpressGUI = class(TBaseListingGUI)
...
procedure TBackorderPurchaseOrderApprovalExpressGUI.grdMainDblClick(
  Sender: TObject);
begin
//  inherited;
...
procedure TBackorderPurchaseOrderApprovalExpressGUI.POChangeBeforeShow(
  Sender: TObject);
begin
  TfmPurchaseOrderChange(Sender).PurchaseOrderID := qryMainPurchaseOrderID.AsInteger;
end;

procedure TBackorderPurchaseOrderApprovalExpressGUI.RefreshQuery;
begin
  qryMain.Close;
...
initialization
  RegisterClass(TBackorderPurchaseOrderApprovalExpressGUI);
