...
C.CUSTFLD1 as SupplierCustFld1, 
C.CUSTFLD2 as SupplierCustFld2, 
C.CUSTFLD3 as SupplierCustFld3,     
C.CUSTFLD4 as SupplierCustFld4, 
C.CUSTFLD5 as SupplierCustFld5, 
C.CUSTFLD6 as SupplierCustFld6,     
C.CUSTFLD7 as SupplierCustFld7, 
C.CUSTFLD8 as SupplierCustFld8, 
C.CUSTFLD9 as SupplierCustFld9,     
C.CUSTFLD10 as SupplierCustFld10, 
C.CUSTFLD11 as SupplierCustFld11, 
C.CUSTFLD12 as SupplierCustFld12,     
C.CUSTFLD13 as SupplierCustFld13, 
C.CUSTFLD14 as SupplierCustFld14, 
C.CUSTFLD15 as SupplierCustFld15,    
C.CUSTDATE1 as SupplierCustDateFld1, 
C.CUSTDATE2 as SupplierCustDateFld3, 
C.CUSTDATE3 as SupplierCustDateFld3,     
If(InStr(P.PRODUCTGROUP,'^') -1 >0,Left(P.PRODUCTGROUP,InStr(P.PRODUCTGROUP,'^')-1),P.PRODUCTGROUP) AS PartHeader, MID(P.PRODUCTGROUP, InStr(P.PRODUCTGROUP,'^')+1 ,  If(LOCATE('^',P.PRODUCTGROUP,InStr(P.PRODUCTGROUP,'^')+1) - InStr(P.PRODUCTGROUP,'^') >0,LOCATE('^',P.PRODUCTGROUP,InStr(P.PRODUCTGROUP,'^')+1)-1 - InStr(P.PRODUCTGROUP,'^'),  IF(InStr(P.PRODUCTGROUP,'^')<>0,CHAR_LENGTH(P.PRODUCTGROUP) - InStr(P.PRODUCTGROUP,'^'),0))) AS PartSubLevel1,    
...
d1.URL as CompanyURL, pp.partpic,   
...
C.BillCountry, 
C.BillPostcode,     
Sum(d3.QtySold* d3.ForeignCurrencyLineCost) EstForeingPrice,   
...
d3.CustomField1 as LineCustFld1, 
d3.CustomField2 as LineCustFld2, 
d3.CustomField3 as LineCustFld3, 
d3.CustomField4 as LineCustFld4, 
d3.CustomField5 as LineCustFld5,     
d3.CustomField6 as LineCustFld6, 
d3.CustomField7 as LineCustFld7, 
d3.CustomField8 as LineCustFld8, 
d3.CustomField9 as LineCustFld9, 
d3.CustomField10 as LineCustFld10,  
ADDDATE(d2.ETADate,-30) as ETADateMinus30Days,     
ADDDATE(d3.ETADate,-30) as LineETADateMinus30Days     
FROM tblCompanyInformation d1, (SELECT @LineCount := 0) dummy, tblPurchaseOrders d2     
