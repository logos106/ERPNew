inherited EmbroideryGUI: TEmbroideryGUI
  Left = 245
  Top = 199
  Caption = 'Embroidery'
  ClientHeight = 345
  ...
  object DNMPanel1: TDNMPanel [1]
    ...
    object wwDBGrid1: TwwDBGrid
      ...
      Height = 209
      ControlType.Strings = (
        'Design;Bitmap;Original Size;Source Copy'
        'ProductName;CustomEdit;cboProduct;F')
      Selected.Strings = (
        'ProductName'#9'20'#9'Product'
        'Qty'#9'10'#9'Qty'
        'Position'#9'10'#9'Position'
        'Name'#9'10'#9'Name'
        'Design'#9'10'#9'Design'
  ...
  object qryMain: TMyQuery
    ...
    object qryMainDesign: TBlobField
      DisplayWidth = 10
      FieldName = 'Design'
      Origin = 'tblembroiderydetails.Design'
    end
    ...
    object qryMainCost: TFloatField
      DisplayWidth = 10
      FieldName = 'Cost'
      Origin = 'tblembroiderydetails.Cost'
    end
