inherited ERPUDHelpDocsGUI: TERPUDHelpDocsGUI
  ExplicitWidth = 1012
  ExplicitHeight = 602
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited qryMain: TERPQuery
    SQL.Strings = (
      ...
      'from tblUDErpHelpDocs'
      'where IsERPTaskItem ="F"  and '
      '((:ContextId =0 and :formContextId=0) or '
      ' ((ContextId =:ContextId ) OR (ContextId =:formContextId )))'
