...
{$WARN SYMBOL_DEPRECATED OFF}      // Resume should be replaced by Start
...
function TPipeThread.SafeSendMessage(Msg : Cardinal; wParam, lParam : Integer)
    : LRESULT;
begin
...
begin
    ...
    case message of
        ...
        CM_EXECPROC : begin
                ...
                with TThreadSync(lParam) do begin
                    // Set message result
                    Result := 0;
                    // Exception trap
                    try
...
begin
    ...
    try
        ...
        if (InstFreeList = nil) then begin
            ...
            until (Longint(lpInst) - Longint(lpBlock) >=
