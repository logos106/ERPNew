...
begin
  result:= 'Update for version 7423 to remove existing layout preferences for all forms and replace with new structure.';
end;
...
begin
  if self.IsERPDatabase(Conn, Version) then begin
    ...
    if Version > '7.4.2.0' then begin
      Script.Connection:= Conn;
      Script.Execute;
      Log('    Done!');
    end
    else begin
      Log('    This database is version ' + Version + ' ... this update is only for version 7.4.2.1 and above.');
    end;
  end;
end;
