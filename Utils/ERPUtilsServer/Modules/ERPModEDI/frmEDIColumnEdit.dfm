object fmEDIColumnEdit: TfmEDIColumnEdit
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 15
  object lblDisplayLablel: TLabel
    Left = 24
    Top = 16
    Width = 88
    Height = 15
    Caption = 'lblDisplayLablel'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Arial'
  ...
  object cboType: TwwDBComboBox
    ...
    Items.Strings = (
      'Text'#9'String'
      'Whole Number'#9'Integer'
      'Number'#9'Float'
      'Currency'#9'Currency'
      'True / False'#9'TrueFalse'
      'Date and Time'#9'DateTime')
    Sorted = False
    TabOrder = 6
